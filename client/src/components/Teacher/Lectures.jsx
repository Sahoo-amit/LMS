...
const Lectures = () => {
  ...
  const getLecture = async () => {
    try {
      const res = await fetch(
        `https://lms-31ko.vercel.app/api/courses/lectures/${id}`,
        {
          method: "GET",
          headers: {
  ...
  const removeLecture = async (lectureId) => {
    try {
      const res = await fetch(
        `https://lms-31ko.vercel.app/api/courses/lecture/${lectureId}`,
        {
          method: "DELETE",
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        `https://lms-31ko.vercel.app/api/courses/${id}/lecture`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
