...
const ForgotPassword = () => {
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      const res = await fetch("https://lms-backend-z77i.onrender.com/api/auth/verify_otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const res = await fetch("https://lms-backend-z77i.onrender.com/api/auth/reset_password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
