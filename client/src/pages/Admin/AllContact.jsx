...
const AllContact = () => {
  ...
  const getUser = async () => {
    try {
      const res = await fetch("https://lms-backend-z77i.onrender.com/api/contact/get_contact", {
        method: "GET",
        headers: {
  ...
  const deleteUser = async (id) => {
    ...
    try {
      await fetch(`https://lms-backend-z77i.onrender.com/api/auth/contact/delete_message`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
