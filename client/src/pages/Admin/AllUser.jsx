...
const AllUser = () => {
  ...
  const getUser = async () => {
    try {
      const res = await fetch("https://lms-9f91.vercel.app/api/auth/allUser", {
        method: "GET",
        headers: {
  ...
  const updateRole = async (id) => {
    try {
      await fetch(`https://lms-9f91.vercel.app/api/auth/updateRole/${id}`, {
        method: "PUT",
        headers: {
  ...
  const deleteUser = async (id) => {
    ...
    try {
      await fetch(`https://lms-9f91.vercel.app/api/auth/deleteUser/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
