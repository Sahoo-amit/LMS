...
const AllUser = () => {
  ...
  const getUser = async () => {
    try {
      const res = await fetch("https://lms-backend-z77i.onrender.com/api/auth/allUser", {
        method: "GET",
        headers: {
  ...
  const updateRole = async (id) => {
    try {
      await fetch(`https://lms-backend-z77i.onrender.com/api/auth/updateRole/${id}`, {
        method: "PUT",
        headers: {
  ...
  const deleteUser = async (id) => {
    ...
    try {
      await fetch(`https://lms-backend-z77i.onrender.com/api/auth/deleteUser/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
